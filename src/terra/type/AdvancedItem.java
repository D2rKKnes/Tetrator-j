...
public class AdvancedItem extends Item {
    ...
    public AdvancedItem(String name) {
        ...
        Events.run(Trigger.update, () -> {
            ...
            Groups.unit.each(u -> u.item() != null && u.stack.item == this, u -> {
        ...
        Events.on(UnitDestroyEvent.class, e -> {
            if(spawnBulletOnDestroy && e.unit.item() != null && e.unit.stack.item == this) spawnBullet(e.unit, e.unit.stack.amount);
        });
