...
public class TerraUnitTypes {
    ...
    public static void load() {
        ...
        consequence = new ErekirUnitType("consequence"){{
            ...
            abilities.add(new SappingFieldAbility(StatusEffects.corroded, 3 * 60f, 5 * 60f, hitSize * 2, greenLight, Fx.overdriveWave));
            ...
            weapons.add(new Weapon("terra-center"){{
                ...
                parts.add(
                    new RegionPart("-ball") {{
                        mirror = false;
                        layerOffset = 50f;
                        progress = growProgress = PartProgress.recoil;
                        color = greenLight;
                        xScl = yScl = 0.4f;
                        growX = growY = -xScl;
                    }}
                ...
                bullet = new BasicBulletType(4.2f, 200){{
                    ...
                    fragVelocityMin = 1f;
                    fragOffsetMax = 1f;
                    fragBullet = new BasicBulletType(0f, 200){{
                        lifetime = 120f;
                        sprite = "terra-plasma";
                        width = height = 18f;
                        shrinkY = 0f;
                        ...
                        intervalBullet = fragBullet = new BasicBulletType(5f, 38){{
                            ...
                            trailLength = 7;
                            trailWidth = 1f;
                            smokeEffect = trailEffect = new Effect(11, e -> {
                            ...
                            hitEffect = despawnEffect = new MultiEffect(trailEffect, new Effect(25f, 100f, e -> {
                        ...
                        hitEffect = despawnEffect = new MultiEffect(TerraFx.circleFadeBig, new WrapEffect(Fx.shootQuellPulse, greenLight), new Effect(60f, 100f, e -> {
                            float circleRad = 5f + e.finpow() * 40f;
                            color(e.color, e.foutpow());
                            Fill.circle(e.x, e.y, circleRad);
                        }));
                        despawnHit = true;
            ...
            new Weapon("terra-small-green-launcher"){{
                ...
                bullet = new BasicBulletType(3.7f, 42){{
                    sprite = "missile-large";
                    width = 5f;
                    height = 7f;
                    shrinkX = shrinkY = 0f;
                    ...
                    trailColor = backColor = hitColor = lightColor = greenLight;
                    frontColor = Color.white;
                    hitEffect = despawnEffect = TerraFx.circleFade;
                }};
            }},
