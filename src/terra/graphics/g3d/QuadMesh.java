...
public class QuadMesh extends PlanetMesh{
    ...
    public void preRender(PlanetParams params){
        ...
        TerraShaders.rings.sunPos = planet.solarSystem.position;
        TerraShaders.rings.planetRadius = planet.radius;

        TerraShaders.rings.inRadius = (radius - stroke/2f) / meshRadius;
        TerraShaders.rings.outRadius = (radius + stroke/2f) / meshRadius;
    }
